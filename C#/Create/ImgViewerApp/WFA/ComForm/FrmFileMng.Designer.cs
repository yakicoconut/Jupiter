namespace WFA
{
  partial class FrmFileMng
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "FrmFileMng";
      this.Opacity = 0.8D;
      this.Text = "FrmFileMng";
      this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FrmFileMng_FormClosing);
      this.Load += new System.EventHandler(this.FrmFileMng_Load);
